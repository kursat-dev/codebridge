...
router.get('/', async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    sendResponse(res, { message: 'List projects - implement me' }, 'listProjects');
  } catch (error) {
    next(error);
  }
});
...
router.post('/', async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    sendCreated(res, { message: 'Create project - implement me' }, 'createProject');
  } catch (error) {
    next(error);
  }
});
...
router.get('/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    sendResponse(res, { message: 'Get project - implement me' }, 'getProject');
  } catch (error) {
    next(error);
  }
});
