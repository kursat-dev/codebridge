...
router.get('/', async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    sendResponse(res, { message: 'List users - implement me' }, 'listUsers');
  } catch (error) {
    next(error);
  }
});
...
router.post('/', async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    sendCreated(res, { message: 'Create user - implement me' }, 'createUser');
  } catch (error) {
    next(error);
  }
});
...
router.get('/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    sendResponse(res, { message: 'Get user - implement me' }, 'getUser');
  } catch (error) {
    next(error);
  }
});
